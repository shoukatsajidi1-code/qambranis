...
export const metadata = {
  ...
  openGraph:{type:'website',siteName:'Qambranis',title:'Qambranis — Wear the Story',description:'Handmade cultural dupattas. Fairly paid artisans. Delivered worldwide.',url:'https://www.qambranis.com',images:[{url:'/images/qambranis-og.jpg',width:1200,height:630,alt:'Qambranis — Empowering Women'}]},
...
const schema={
 '@context':'https://schema.org','@type':'Organization',name:'Qambranis',url:'https://www.qambranis.com',email:'info@qambranis.com',telephone:'+923363377447',description:'Handmade cultural dupattas crafted by women artisans in interior Sindh.',sameAs:['https://www.instagram.com/qambranisofficial','https://www.facebook.com/qambranisofficial','https://www.tiktok.com/@qambranisofficial']
};
