...
export default function Home(){
  ...
  return <main>
    ...
    <header className="nav">
      <a className="brandLogo" href="#top" aria-label="Qambranis home"><Image src="/images/logo-transparent.png" alt="Qambranis — Empowering Women" width={240} height={176} priority/></a>
