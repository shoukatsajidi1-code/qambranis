...
export default function PolicyPage({eyebrow,title,children}){
  return <main className="policyShell">
    <header className="policyNav"><Link className="policyBrand policyWordmark" href="/">QAMBRANIS<span>Empowering Women</span></Link><Link className="policyBack" href="/">Back to shop</Link></header>
